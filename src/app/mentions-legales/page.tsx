      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#FFF4E5] border-l-4 border-[#FF5500] rounded-r-xl p-5 mb-12 text-sm text-[#374151]">
            <strong className="text-[#1A2B3C]">Document provisoire.</strong> Cette page a été rédigée à
          ...
          <Section title="Éditeur du site">
            ...
            <p>
              Contact : <a href="mailto:contact@akililabs.io" className="text-[#c94200] hover:underline">contact@akililabs.io</a>
            </p>
          </Section>
          ...
          <Section title="Données personnelles">
            <p>
              ...
              détaillé dans notre{" "}
              <a href="/confidentialite" className="text-[#c94200] hover:underline">
