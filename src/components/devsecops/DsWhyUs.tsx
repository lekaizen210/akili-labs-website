...
import { Map, Route, Users, GitBranch, MapPin } from "lucide-react";
...
const dsWhyUsIcons = [Map, Route, Users, GitBranch, MapPin] as const;

export default function DsWhyUs() {
  const t = useTranslations("DevSecOps.whyUs");
