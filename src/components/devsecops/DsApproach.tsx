...
import { Rocket, ShieldCheck, Compass, GraduationCap } from "lucide-react";
import { StaggerContainer, StaggerItem } from "@/components/ui/motion-primitives";
import ParticleCanvas from "@/components/ui/ParticleCanvas";
import { dsApproach } from "@/lib/devsecops-data";

const icons = [Rocket, ShieldCheck, Compass, GraduationCap] as const;

export default function DsApproach() {
  return (
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-white mb-4">
            Une approche centrée sur la fiabilité, pas sur les outils à la mode
          </h2>
        </div>
