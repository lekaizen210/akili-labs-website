      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeUp delay={0.1} className="mt-14 max-w-4xl mx-auto">
          <Image
            ...
            alt="Supervision de l’instance Odoo : disponibilité de 99,95 % sur 12 mois contre un objectif contractuel de 99,5 %, incident détecté et résolu en 31 minutes, et tickets TMA P1 à P3 traités dans les délais contractuels"
            width={1400}
            height={900}
            loading="lazy"
