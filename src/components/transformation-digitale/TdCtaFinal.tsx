      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeUp>
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
            Votre transformation mérite mieux qu&apos;un{" "}
            <span className="text-orange">empilement d&apos;outils.</span>
          </h2>
        </FadeUp>
        <FadeUp delay={0.1}>
          <p className="text-white/70 mb-10 max-w-xl mx-auto">
            Commençons par un diagnostic : nos experts analysent votre existant et vous proposent
            une feuille de route adaptée à votre contexte métier et réglementaire.
          </p>
        </FadeUp>
        <motion.div
          initial="hidden"
