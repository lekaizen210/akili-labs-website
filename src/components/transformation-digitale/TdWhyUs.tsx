...
import { Map, Route, Users, Scale, MapPin } from "lucide-react";
import { useLocale, useTranslations } from "next-intl";
import { StaggerContainer, StaggerItem } from "@/components/ui/motion-primitives";
import ParticleCanvas from "@/components/ui/ParticleCanvas";
import { tdWhyUs } from "@/lib/transformation-digitale-data";
import { l } from "@/lib/i18n-content";

const tdWhyUsIcons = [Map, Route, Users, Scale, MapPin] as const;

export default function TdWhyUs() {
  const t = useTranslations("Td.whyUs");
