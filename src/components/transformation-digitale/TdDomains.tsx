      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-navy mb-3">
            Sept leviers, un objectif : des processus plus rapides et traçables
          </h2>
          <p className="text-ink max-w-2xl mx-auto">
            Et moins dépendants des personnes clés — chaque levier s&apos;attaque à une source
            précise de friction dans votre organisation.
          </p>
        </div>
