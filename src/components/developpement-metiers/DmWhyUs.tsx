...
import { Map, Route, Users, BadgeCheck, MapPin } from "lucide-react";
import { useLocale, useTranslations } from "next-intl";
import { StaggerContainer, StaggerItem } from "@/components/ui/motion-primitives";
import ParticleCanvas from "@/components/ui/ParticleCanvas";
import { dmWhyUs } from "@/lib/developpement-metiers-data";
import { l } from "@/lib/i18n-content";

const dmWhyUsIcons = [Map, Route, Users, BadgeCheck, MapPin] as const;

export default function DmWhyUs() {
  const t = useTranslations("DevMetiers.whyUs");
