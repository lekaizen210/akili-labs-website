...
export default function DmCtaFinal() {
  return (
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeUp>
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">
            Votre prochain projet sur mesure peut être{" "}
            <span className="text-orange">celui qui se passe bien.</span>
          </h2>
        </FadeUp>
        <FadeUp delay={0.1}>
          <p className="text-white/70 mb-10 max-w-xl mx-auto">
            Commençons par un cadrage : nos experts analysent vos processus, vous disent
            honnêtement ce qui relève du sur mesure — et verrouillent avec vous le périmètre, le
            budget et les garde-fous avant la première ligne de code.
          </p>
        </FadeUp>
        <motion.div
          initial="hidden"
