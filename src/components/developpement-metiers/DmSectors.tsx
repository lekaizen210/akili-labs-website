...
import { Landmark, ShoppingBag, Wheat, Building2, HeartPulse, Radio } from "lucide-react";
import { useLocale, useTranslations } from "next-intl";
import { StaggerContainer, StaggerItem } from "@/components/ui/motion-primitives";
import { dmSectorUseCases } from "@/lib/developpement-metiers-data";
import { l } from "@/lib/i18n-content";

const icons = { Landmark, ShoppingBag, Wheat, Building2, HeartPulse, Radio } as const;

export default function DmSectors() {
  const t = useTranslations("DevMetiers.sectors");
          ...
          {dmSectorUseCases.map((s) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-ink leading-relaxed">{l(s.useCases, locale)}</p>
              </StaggerItem>
            );
          })}
        </StaggerContainer>
